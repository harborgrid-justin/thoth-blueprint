...
/** Length units a plan can be expressed in. Attached explicitly ΓÇö never implied. */
...
export interface ElementBase {
   ...
   * i ΓåÆ i+1). Absent or empty means every edge is a straight line.
   */
  arcs?: EdgeArcs;
...
/** An area bounded by rights-of-way that contains lots (parcel ΓåÆ block ΓåÆ lot). */
...
export interface Zone extends ElementBase {
  ...
  /** Maximum building coverage as a fraction of lot area (0ΓÇô1). */
  maxCoverage?: number;
...
/** Land reserved for streets, paths, or utilities ΓÇö typically public. */
...
/** A body of water ΓÇö a landscape and drainage feature. */
...
export interface PlantingArea extends ElementBase {
  ...
  /** Estimated canopy/cover fraction (0ΓÇô1) for landscape metrics. */
  canopyCover?: number;
}
...
/** A surveyed spot elevation / benchmark ΓÇö a control point for the terrain surface. */
...
export interface Site {
  ...
  /** Civil / erosion-control line features (silt fence, tree line, flow, ΓÇª). */
  controlLines?: ControlLine[];
  /** Civil / erosion-control point symbols (inlet protection, ditch check, ΓÇª). */
