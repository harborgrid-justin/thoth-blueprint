import { bounds, closestPointOnSegment, distance, dot, length } from "./geometry";
import type { Bounds, Point } from "./types";

/**
 * Advanced CAD, vector, and snapping mathematics for Thoth Blueprint domain.
 * Complements the basic spatial functions in geometry.ts.
 */
