...
export const HATCH_PATTERNS: HatchPattern[] = [
  { id: "ansi31", label: "ANSI31 (diagonal)", kind: "lines", angleDeg: 45, spacing: 2.5, lineWeight: "fine", color: "#334155" },
  { id: "ansi37", label: "ANSI37 (crosshatch)", kind: "crosshatch", angleDeg: 45, spacing: 2.5, lineWeight: "fine", color: "#334155" },
  { id: "concrete", label: "Concrete", kind: "dots", angleDeg: 0, spacing: 2, lineWeight: "fine", color: "#64748b" },
  { id: "earth", label: "Earth", kind: "lines", angleDeg: 45, spacing: 3, lineWeight: "fine", color: "#92400e" },
  { id: "gravel", label: "Gravel", kind: "dots", angleDeg: 0, spacing: 2.5, lineWeight: "fine", color: "#78716c" },
  { id: "sand", label: "Sand", kind: "dots", angleDeg: 0, spacing: 1.4, lineWeight: "fine", color: "#a16207" },
  { id: "steel", label: "Steel", kind: "lines", angleDeg: 45, spacing: 1.8, lineWeight: "thin", color: "#1e293b" },
  { id: "insulation", label: "Insulation (batt)", kind: "lines", angleDeg: 0, spacing: 3, lineWeight: "fine", color: "#0ea5e9" },
  { id: "brick", label: "Brick", kind: "grid", angleDeg: 0, spacing: 3, lineWeight: "fine", color: "#b91c1c" },
  { id: "water", label: "Water", kind: "lines", angleDeg: 0, spacing: 2.5, lineWeight: "fine", color: "#0284c7" },
  { id: "wood", label: "Wood", kind: "lines", angleDeg: 0, spacing: 1.6, lineWeight: "fine", color: "#a16207" },
  { id: "grass", label: "Grass / turf", kind: "dots", angleDeg: 0, spacing: 3, lineWeight: "fine", color: "#15803d" },
];
