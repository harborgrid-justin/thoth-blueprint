/* @ts-self-types="./thoth_bindings.d.ts" */
...
export function centroid(polygon) {
    const ret = wasm.centroid(polygon);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
...
export function offsetPolygon(polygon, distance) {
    const ret = wasm.offsetPolygon(polygon, distance);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function perimeter(polygon) {
    const ret = wasm.perimeter(polygon);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0];
...
export function pointInPolygon(point, polygon) {
    const ret = wasm.pointInPolygon(point, polygon);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] !== 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('thoth_bindings_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
