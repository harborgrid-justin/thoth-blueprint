...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed top-1/2 left-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 animate-fade-in gap-4 rounded-lg border border-border bg-card p-6 shadow-xl",
        className,
      )}
      {...props}
    >
