...
export function MetesAndBoundsDialog() {
  ...
  return (
    <DialogShell
      ...
      description="Hand-enter survey bearing and distance calls to construct an exact plat diagram on the canvas."
    ...
    >
      <div className="grid gap-4 text-xs md:grid-cols-3">
        ...
        <div className={SURVEY_STYLES.card + " space-y-3"}>
          ...
          <div className="flex h-40 items-center justify-center overflow-hidden rounded border border-border bg-background">
            <svg viewBox={`${minX} ${minY} ${vw} ${vh}`} className="h-full w-full">
              <polygon
          ...
          <Button className={SURVEY_STYLES.btnPrimary + " w-full"} size="sm" onClick={commitPlatToCanvas}>
            <CheckCircle2 className="mr-1.5 h-4 w-4" /> Draw Plat on Canvas
          </Button>
        </div>
      </div>
    </DialogShell>
