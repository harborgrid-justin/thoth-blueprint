    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-2xl bg-slate-900 border-slate-700 text-slate-100 p-6">
        ...
        <Tabs value={activeTab} onValueChange={(val) => setActiveTab(val as any)}>
          <TabsList className="bg-slate-950 border border-slate-800 p-1 w-full justify-start gap-1">
        ...
        {activeTab === 'grid' && (
          <div className="flex flex-col gap-3 text-xs pt-2">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <span className="block text-slate-400 mb-1 font-semibold">Start Point Grid Coordinates</span>
                <label className="block text-slate-400">Northing (Y):</label>
                <Input
                  type="number"
                  value={gridStart.northing}
                  onChange={(e) => setGridStart({ ...gridStart, northing: Number(e.target.value) })}
                  className="bg-slate-800 border-slate-700 text-slate-200 h-8 text-xs mb-2"
                />
                <label className="block text-slate-400">Easting (X):</label>
                <Input
                  type="number"
              ...
              <div>
                <span className="block text-slate-400 mb-1 font-semibold">End Point Grid Coordinates</span>
                <label className="block text-slate-400">Northing (Y):</label>
                <Input
                  type="number"
            ...
            {gridResultLine && (
              <div className="bg-slate-950 p-2.5 rounded font-mono text-cyan-300">
        ...
        {activeTab === 'latlon' && (
          <div className="flex flex-col gap-3 text-xs pt-2">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <span className="block text-slate-400 mb-1 font-semibold">Start Lat/Lon (WGS84)</span>
              ...
              <div>
                <span className="block text-slate-400 mb-1 font-semibold">End Lat/Lon (WGS84)</span>
                <label className="block text-slate-400">Latitude:</label>
                <Input
                  type="number"
                  step="0.0001"
        ...
        {activeTab === 'deflection' && (
          <div className="flex flex-col gap-3 text-xs pt-2">
            <div className="grid grid-cols-4 gap-2">
              <div>
                <label className="block text-slate-400">Start Pt X:</label>
                <Input
                  type="number"
                  value={startPt.x}
              ...
              <div>
                <label className="block text-slate-400">Reference Bearing:</label>
                <Input
                  type="number"
                  value={refBearing}
              ...
              <div>
                <label className="block text-slate-400">Deflection Angle:</label>
                <Input
                  type="number"
              ...
              <div>
                <label className="block text-slate-400">Distance (ft):</label>
                <Input
                  type="number"
                  value={distFt}
        ...
        {activeTab === 'station' && (
          <div className="flex flex-col gap-3 text-xs pt-2">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-slate-400">Target Station (ft):</label>
                <Input
                  type="number"
                  value={targetStation}
              ...
              <div>
                <label className="block text-slate-400">Target Offset (+R / -L ft):</label>
                <Input
                  type="number"
                  value={targetOffset}
        ...
        {activeTab === 'tangent' && (
          <div className="flex flex-col gap-3 text-xs pt-2">
            <div className="flex gap-2">
              ...
              <Button onClick={handleCreatePerpendicularLine} variant="outline" className="border-slate-700 text-amber-300 bg-slate-800 hover:bg-slate-700">
        ...
        {activeTab === 'row' && (
          <div className="flex flex-col gap-3 text-xs pt-2">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-slate-400">R.O.W. Dedication Width (ft):</label>
                <Input
                  type="number"
                  value={rowWidth}
              ...
              <div>
                <label className="block text-slate-400">Remainder Parcel Depth (ft):</label>
                <Input
                  type="number"
                  value={rowDepth}
            ...
            {rowParcelResult && (
              <div className="bg-slate-950 p-2.5 rounded font-mono text-cyan-300 flex flex-col gap-1">
