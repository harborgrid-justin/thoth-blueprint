...
export function CanvasPatterns() {
  return (
    <defs>
      ...
      <pattern id="pat-water" width={26} height={11} patternUnits="userSpaceOnUse">
        <path d="M0 6 Q 6.5 1 13 6 T 26 6" fill="none" stroke="#0ea5e9" strokeWidth={0.8} opacity={0.55} />
      </pattern>

      {/* Wetland — water lines with marsh tufts. */}
      <pattern id="pat-wetland" width={28} height={20} patternUnits="userSpaceOnUse">
        <line x1={0} y1={13} x2={28} y2={13} stroke="#0ea5e9" strokeWidth={0.6} opacity={0.5} />
        <line x1={6} y1={17} x2={20} y2={17} stroke="#0ea5e9" strokeWidth={0.6} opacity={0.5} />
        <path d="M6 12 L6 5 M4 8 L6 5 L8 8" fill="none" stroke="#15803d" strokeWidth={0.7} opacity={0.7} />
        <path d="M20 12 L20 6 M18 9 L20 6 L22 9" fill="none" stroke="#15803d" strokeWidth={0.7} opacity={0.7} />
      </pattern>
      ...
      <pattern id="pat-orchard" width={16} height={16} patternUnits="userSpaceOnUse">
        <circle cx={8} cy={8} r={1.6} fill="none" stroke="#16a34a" strokeWidth={0.7} opacity={0.6} />
      </pattern>

      {/* Agricultural / crop — plow rows. */}
      <pattern id="pat-ag" width={12} height={9} patternUnits="userSpaceOnUse">
        <line x1={0} y1={4.5} x2={12} y2={4.5} stroke="#a16207" strokeWidth={0.5} opacity={0.5} />
      </pattern>
      ...
      <pattern id="pat-earth" width={8} height={8} patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
        <line x1={0} y1={0} x2={0} y2={8} stroke="#b45309" strokeWidth={0.6} opacity={0.45} />
      </pattern>
      ...
      <pattern id="pat-concrete" width={7} height={7} patternUnits="userSpaceOnUse">
        <circle cx={1} cy={1} r={0.5} fill="#94a3b8" opacity={0.7} />
      </pattern>

      {/* Open space / park — sparse dots. */}
      <pattern id="pat-park" width={16} height={16} patternUnits="userSpaceOnUse">
