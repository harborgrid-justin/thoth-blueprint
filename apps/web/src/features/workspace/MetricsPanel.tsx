  ...
  return (
    <div className="flex flex-col gap-4 p-3">
      ...
      <div className="grid grid-cols-2 gap-2">
        <Stat label="Site area" value={formatArea(metrics.siteArea, areaUnit)} />
        ...
        <Stat label="Dwelling units" value={formatNumber(metrics.dwellingUnits)} />
        <Stat label="Density" value={`${formatNumber(metrics.density, 1)} du/ac`} />
      ...
      <div>
        ...
        {metrics.allocation.length === 0 ? (
          <p className="text-xs text-muted-foreground/70">Draw land-use areas to see allocation.</p>
        ) : (
          <>
            ...
            <ul className="mt-2 flex flex-col gap-1">
              {metrics.allocation.map((slice) => (
                <li key={slice.category} className="flex items-center gap-2 text-xs">
                  ...
                  <span className="tabular-nums text-muted-foreground">{formatArea(slice.area, areaUnit)}</span>
