          ...
          return (
            <DropdownMenuItem
              ...
              className={cn(
                ...
                isSelected ? "bg-cyan-500/20 border-l-2 border-cyan-400 font-medium text-cyan-200" : "hover:bg-slate-800 text-slate-300"
              )}
            >
              ...
              <div className="flex w-full items-center gap-2.5 text-[10px] text-slate-400 font-mono">
                <span>🌧 {rainfall} in/h</span>
                <span>💨 {wind} mph</span>
                <span>❄️ {snow} psf</span>
                {isSelected && <Check className="ml-auto h-3 w-3 text-cyan-400 shrink-0" />}
              </div>
            </DropdownMenuItem>
          );
        })}
