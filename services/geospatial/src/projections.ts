...
const PROJECTION_DEFS: Record<string, string> = {
  ...
  "EPSG:2225": "+proj=lcc +lat_1=41.66666666666666 +lat_2=40 +lat_0=39.33333333333334 +lon_0=-122 +x_0=2000000.0001016 +y_0=500000.0001016001 +ellps=GRS80 +datum=NAD83 +to_meter=0.3048006096012192 +no_defs",
  "EPSG:2226": "+proj=lcc +lat_1=39.83333333333334 +lat_2=38.33333333333334 +lat_0=37.66666666666666 +lon_0=-122 +x_0=2000000.0001016 +y_0=500000.0001016001 +ellps=GRS80 +datum=NAD83 +to_meter=0.3048006096012192 +no_defs",
  "EPSG:2227": "+proj=lcc +lat_1=38.43333333333333 +lat_2=37.06666666666667 +lat_0=36.5 +lon_0=-120.5 +x_0=2000000.0001016 +y_0=500000.0001016001 +ellps=GRS80 +datum=NAD83 +to_meter=0.3048006096012192 +no_defs",
  "EPSG:2228": "+proj=lcc +lat_1=36 +lat_2=34.03333333333333 +lat_0=34.75 +lon_0=-119 +x_0=2000000.0001016 +y_0=500000.0001016001 +ellps=GRS80 +datum=NAD83 +to_meter=0.3048006096012192 +no_defs",
  "EPSG:2229": "+proj=lcc +lat_1=34.63333333333333 +lat_2=32.78333333333333 +lat_0=34.08333333333334 +lon_0=-118.25 +x_0=2000000.0001016 +y_0=500000.0001016001 +ellps=GRS80 +datum=NAD83 +to_meter=0.3048006096012192 +no_defs",
};
...
export function reprojectPoint(point: Point, fromCrs: string, toCrs: string): Point {
...
export function reprojectPoints(points: Point[], fromCrs: string, toCrs: string): Point[] {
  const fromDef = getProjectionDef(fromCrs);
  const toDef = getProjectionDef(toCrs);
...
export function reprojectBounds(bounds: Bounds, fromCrs: string, toCrs: string): Bounds {
  const corners = [
