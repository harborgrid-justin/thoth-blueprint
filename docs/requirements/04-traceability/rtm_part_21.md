...
| REQ-21-003 | Materials > Material List | The system shall support creating Material Lists that associate corridor sections with QTO criteria for volume computation. | Trace-to-Spec-v1 | Implemented in [calculateEarthworkVolumes](../../../packages/domain/src/civil/sections.ts#L90) |
| REQ-21-004 | Materials > Volume Report | The system shall support generating volume reports (Average End Area, earthwork summary) in HTML/XML formats. | Trace-to-Spec-v1 | Implemented in [calculateEarthworkVolumes](../../../packages/domain/src/civil/sections.ts#L90) & [RoadDesignStudioDialog.tsx](../../../apps/web/src/features/survey/RoadDesignStudioDialog.tsx) |
| REQ-21-005 | Materials > Mass Haul Diagram | The system shall generate Mass Haul Diagrams plotting cumulative cut/fill volumes along an alignment. | Trace-to-Spec-v1 | `../../../packages/domain/src/drawing/qto.ts#L106` (`calculateMassHaul`) |
| REQ-21-006 | Materials > Mass Haul Balancing | The system shall support adding free haul and borrow pit stations to balance mass haul volumes. | Trace-to-Spec-v1 | `../../../packages/domain/src/drawing/qto.ts#L106` (`calculateMassHaul`) |
...
| REQ-21-008 | Materials > Pay Item List | The system shall support loading and navigating Pay Item lists from CSV files with categorized pay item IDs. | Trace-to-Spec-v1 | `../../../packages/domain/src/drawing/qto.ts#L181` (`parsePayItemListCsv`) |
...
| REQ-21-011 | Materials > Assign to Corridors | The system shall support assigning Pay Item codes to corridor feature lines and corridor links. | Trace-to-Spec-v1 | Implemented in [calculateEarthworkVolumes](../../../packages/domain/src/civil/sections.ts#L90) & [QtoPanel.tsx](../../../apps/web/src/features/workspace/QtoPanel.tsx) |
