...
| --- | --- | --- | --- | :--: | :--: | :--: | :--: |
| BE-AUTH-001 | None | STK-006 | DEP-001 | P2 | M | T | ⬜ |
| BE-AUTH-002 | None | STK-006 | NFR-SEC-002 | P2 | M | T | ⬜ |
| BE-AUTH-003 | None | STK-006 | — | P2 | M | T | ⬜ |
| BE-AUTH-004 | None | STK-006 | BR-009 | P2 | M | T | ⬜ |
| BE-AUTH-005 | None | STK-006 | — | P2 | M | T | ⬜ |
| BE-AUTH-006 | None | STK-006 | — | P4 | S | T | ⬜ |
| BE-AUTH-007 | None | STK-006 | NFR-PRIV-003 | P4 | S | T | ⬜ |
| BE-ACCESS-001 | None | STK-006 | NFR-SEC-003 | P2 | M | T | ⬜ |
| BE-ACCESS-002 | None | STK-003, STK-006 | BR-007 | P4 | M | T | ⬜ |
| BE-ACCESS-003 | None | STK-005 | BR-009 | P4 | S | T | ⬜ |
| BE-ACCESS-004 | None | STK-006 | — | P4 | S | T | ⬜ |
| BE-ACCESS-005 | None | STK-006 | NFR-SEC-001 | P4 | S | T | ⬜ |
| BE-ACCESS-006 | None | STK-006 | BR-007 | P4 | M | T | ⬜ |
| BE-PROJECT-001 | None | STK-006 | — | P2 | M | T | ⬜ |
| BE-PROJECT-002 | None | STK-001 | CON-002 | P2 | M | T | ⬜ |
| BE-PROJECT-003 | None | STK-006 | NFR-PRIV-001 | P2 | M | T | ⬜ |
| BE-PROJECT-004 | None | STK-003 | NFR-REL-002 | P4 | M | T | ⬜ |
| BE-PROJECT-005 | None | STK-003 | CON-010, NFR-MAINT-001 | P2 | M | T | ⬜ |
| BE-PROJECT-006 | None | STK-004 | — | P4 | S | T | ⬜ |
| BE-PROJECT-007 | None | STK-002, STK-004 | — | P4 | C | T | ⬜ |
| BE-PROJECT-008 | None | STK-006 | NFR-PRIV-003 | P4 | S | T | ⬜ |
| BE-VERSION-001 | None | STK-003 | BR-007 | P4 | M | T | ⬜ |
| BE-VERSION-002 | None | STK-003 | BR-007 | P2 | M | T | ⬜ |
| BE-VERSION-003 | None | STK-003 | BR-007 | P2 | M | T | ⬜ |
| BE-VERSION-004 | None | STK-003 | BR-007 | P4 | S | T | ⬜ |
| BE-VERSION-005 | None | STK-003 | BR-007 | P4 | C | T | ⬜ |
| BE-GEO-001 | None | STK-001 | BR-004, DEP-002 | P3 | M | T | ⬜ |
| BE-GEO-002 | None | STK-002 | BR-002 | P3 | M | T | ⬜ |
| BE-GEO-003 | None | STK-002 | BR-008 | P3 | S | T | ⬜ |
| BE-GEO-004 | None | STK-001 | BR-004, NFR-COMPAT-002 | P3 | M | T | ⬜ |
| BE-GEO-005 | None | STK-001 | NFR-LEGAL-002, DEP-003 | P3 | S | T | ⬜ |
| BE-IMPORT-001 | None | STK-001, STK-007 | BR-005 | P3 | M | T | ⬜ |
| BE-IMPORT-002 | None | STK-001 | BR-004 | P3 | M | T | ⬜ |
| BE-IMPORT-003 | None | STK-007 | NFR-REL-003 | P3 | M | T | ⬜ |
| BE-EXPORT-001 | None | STK-004, STK-007 | BR-005 | P3 | M | T | ⬜ |
| BE-EXPORT-002 | None | STK-004 | BR-005 | P3 | S | T | ⬜ |
| BE-EXPORT-003 | None | STK-004 | BR-005 | P3 | S | D | ⬜ |
| BE-JOB-001 | None | STK-001, STK-007 | NFR-PERF-005 | P3 | M | T | ⬜ |
| BE-JOB-002 | None | STK-007 | NFR-OBS-002 | P3 | M | T | ⬜ |
| BE-JOB-003 | None | STK-007 | — | P3 | S | T | ⬜ |
| BE-JOB-004 | None | STK-004, STK-007 | NFR-SEC-002 | P3 | S | T | ⬜ |
| BE-STORAGE-001 | None | STK-001, STK-004 | — | P3 | M | T | ⬜ |
| BE-STORAGE-002 | None | STK-006 | NFR-PRIV-001 | P3 | M | T | ⬜ |
| BE-STORAGE-003 | None | STK-007 | NFR-SEC-006 | P3 | S | T | ⬜ |
| BE-STORAGE-004 | None | STK-006 | NFR-PRIV-003 | P4 | S | T | ⬜ |
| BE-COLLAB-001 | None | STK-003 | BR-003 | P4 | M | T | ⬜ |
| BE-COLLAB-002 | None | STK-003 | NFR-REL-002 | P4 | M | T | ⬜ |
| BE-COLLAB-003 | None | STK-003 | BR-003 | P4 | M | T | ⬜ |
| BE-COLLAB-004 | None | STK-003 | BR-003 | P4 | C | T | ⬜ |
| BE-COLLAB-005 | None | STK-003 | NFR-REL-005 | P4 | S | T | ⬜ |
| BE-COLLAB-006 | None | STK-003 | CON-002, NFR-REL-005 | P5 | C | T | ⬜ |
| BE-COMMENT-001 | None | STK-003 | BR-003 | P4 | M | T | ⬜ |
| BE-COMMENT-002 | None | STK-003 | BR-003 | P4 | M | T | ⬜ |
| BE-COMMENT-003 | None | STK-003 | BR-003 | P4 | S | T | ⬜ |
| BE-COMMENT-004 | None | STK-003 | — | P4 | C | T | ⬜ |
| BE-NOTIFY-001 | None | STK-003, STK-006 | BR-003 | P4 | S | T | ⬜ |
| BE-NOTIFY-002 | None | STK-003, STK-006 | — | P4 | S | T | ⬜ |
| BE-NOTIFY-003 | None | STK-006 | NFR-PRIV-004 | P4 | C | T | ⬜ |
| BE-SEARCH-001 | None | STK-006 | — | P2 | M | T | ⬜ |
| BE-SEARCH-002 | None | STK-006 | — | P2 | S | T | ⬜ |
| BE-SEARCH-003 | None | STK-006 | — | P4 | C | T | ⬜ |
| BE-AUDIT-001 | None | STK-003, STK-006 | BR-007 | P4 | M | T | ⬜ |
| BE-AUDIT-002 | None | STK-006 | BR-007 | P4 | S | T | ⬜ |
| BE-AUDIT-003 | None | STK-003 | NFR-SEC-001 | P4 | C | A | ⬜ |
| BE-AUDIT-004 | None | STK-006 | NFR-SEC-001 | P4 | S | T | ⬜ |
| BE-WEBHOOK-001 | None | STK-007 | BR-010 | P5 | C | T | ⬜ |
| BE-WEBHOOK-002 | None | STK-007 | NFR-SEC-001 | P5 | C | T | ⬜ |
| BE-API-001 | None | STK-007 | BR-010 | P3 | S | I | ⬜ |
| BE-API-002 | None | STK-007 | NFR-SEC-003 | P3 | M | T | ⬜ |
| BE-API-003 | None | STK-007 | NFR-MAINT-005 | P3 | S | I | ⬜ |
| BE-API-004 | None | STK-007 | BR-005 | P3 | S | T | ⬜ |
| BE-API-005 | None | STK-007 | NFR-REL-001 | P3 | S | T | ⬜ |
| BE-API-006 | None | STK-007 | NFR-MAINT-001 | P3 | S | I | ⬜ |
| BE-API-007 | None | STK-007 | NFR-OBS-002 | P3 | S | I | ⬜ |
| BE-API-008 | None | STK-007 | NFR-REL-002 | P3 | S | T | ⬜ |
| BE-SHEET-001 | None | STK-008 | BR-012, CON-012 | P6 | M | T | ⬜ |
| BE-SHEET-002 | None | STK-008 | BR-012 | P6 | M | T | ⬜ |
| BE-SHEET-003 | None | STK-008 | BR-012 | P6 | M | T | ⬜ |
| BE-SHEET-004 | None | STK-008 | BR-012 | P6 | M | T | ⬜ |
| BE-SHEET-005 | None | STK-008 | NFR-PLOT-001, NFR-PLOT-002 | P6 | M | A | ⬜ |
| BE-SHEET-006 | None | STK-008 | NFR-REL-003 | P6 | M | T | ⬜ |
| BE-TEMPLATE-001 | None | STK-008, STK-006 | BR-012 | P6 | M | T | ⬜ |
| BE-TEMPLATE-002 | None | STK-008, STK-006 | BR-012 | P6 | S | T | ⬜ |
| BE-TEMPLATE-003 | None | STK-006 | BR-012, NFR-MAINT-005 | P6 | S | T | ⬜ |
| BE-TEMPLATE-004 | None | STK-006 | NFR-PRIV-001 | P6 | M | T | ⬜ |
| BE-PLOT-001 | None | STK-008 | BR-012, CON-011 | P6 | M | T | ⬜ |
| BE-PLOT-002 | None | STK-008, STK-007 | BR-012, NFR-PERF-005 | P6 | M | T | ⬜ |
| BE-PLOT-003 | None | STK-008, STK-007 | NFR-SEC-002 | P6 | M | T | ⬜ |
| BE-PLOT-004 | None | STK-008 | NFR-PLOT-002 | P6 | S | T | ⬜ |
| BE-PLOT-005 | None | STK-008 | BR-012, DEP-005 | P6 | S | T | ⬜ |
| BE-PLOT-006 | None | STK-008 | NFR-REL-003 | P6 | S | T | ⬜ |
| BE-SCHEDULE-001 | None | STK-008 | BR-012, CON-012 | P6 | M | T | ⬜ |
| BE-SCHEDULE-002 | None | STK-008 | BR-012, CON-012 | P6 | M | T | ⬜ |
| BE-SCHEDULE-003 | None | STK-008 | NFR-REL-002 | P6 | M | T | ⬜ |
| BE-SCHEDULE-004 | None | STK-007 | BR-005 | P6 | S | T | ⬜ |
| BE-PACKAGE-001 | None | STK-008 | BR-012, BR-007 | P6 | M | T | ⬜ |
| BE-PACKAGE-002 | None | STK-008 | BR-012, DEP-005 | P6 | M | T | ⬜ |
| BE-PACKAGE-003 | None | STK-008, STK-003 | NFR-SEC-001, BR-007 | P6 | S | T | ⬜ |
| BE-PACKAGE-004 | None | STK-003, STK-008 | NFR-AVAIL-002, BR-007 | P6 | M | T | ⬜ |
| BE-PACKAGE-005 | None | STK-003 | BR-007, NFR-SEC-001 | P6 | S | T | ⬜ |
...
| `services/geospatial` | IOP-BLOCK, IOP-BUNDLE, IOP-CRSX, IOP-CSV, IOP-DXF, IOP-DXFSHEET, IOP-ENC, IOP-FIELD, IOP-GEOJSON, IOP-GEOMX, IOP-GPKG, IOP-IDENT, IOP-KML, IOP-LAYERMAP, IOP-PDF, IOP-PDFSHEET, IOP-PLTSTYLE, IOP-PREC, IOP-RASTER, IOP-SCHEMA, IOP-SHP, IOP-STREAM, IOP-TITLEBLOCK | 59 |
...
| `None` | BE-ACCESS, BE-API, BE-AUDIT, BE-AUTH, BE-COLLAB, BE-COMMENT, BE-EXPORT, BE-GEO, BE-IMPORT, BE-JOB, BE-NOTIFY, BE-PACKAGE, BE-PLOT, BE-PROJECT, BE-SCHEDULE, BE-SEARCH, BE-SHEET, BE-STORAGE, BE-TEMPLATE, BE-VERSION, BE-WEBHOOK | 100 |
| | **Total** | **500** |
